...
_lr_productions = [
  ...
  ('program -> statements','program',1,'p_program','CH12.py',62),
  ('statements -> statements statement','statements',2,'p_statements','CH12.py',69),
  ('statements -> statement','statements',1,'p_statements','CH12.py',70),
  ('statement -> assignment','statement',1,'p_statement','CH12.py',81),
  ('statement -> operation','statement',1,'p_statement','CH12.py',82),
  ('statement -> print','statement',1,'p_statement','CH12.py',83),
  ('assignment -> VARIABLE = NUMBER','assignment',3,'p_assignment','CH12.py',90),
  ('operation -> VARIABLE = expr','operation',3,'p_operation','CH12.py',99),
  ('expr -> expr + term','expr',3,'p_expr','CH12.py',112),
  ('expr -> expr - term','expr',3,'p_expr','CH12.py',113),
  ('expr -> term','expr',1,'p_expr','CH12.py',114),
  ('term -> term * factor','term',3,'p_term','CH12.py',125),
  ('term -> term / factor','term',3,'p_term','CH12.py',126),
  ('term -> factor','term',1,'p_term','CH12.py',127),
  ('factor -> VARIABLE','factor',1,'p_factor','CH12.py',138),
  ('factor -> NUMBER','factor',1,'p_factor','CH12.py',139),
  ('print -> PRINT ( values )','print',4,'p_print','CH12.py',151),
  ('values -> VARIABLE','values',1,'p_values','CH12.py',160),
  ('values -> values , VARIABLE','values',3,'p_values','CH12.py',161),
]
